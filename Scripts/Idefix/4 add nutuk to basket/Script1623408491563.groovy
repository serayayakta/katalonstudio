...
WebUI.click(findTestObject('Object Repository/Page_Kitap, Hobi, Oyuncak, Kulaklk, ok Sata_319555/a_SEPETE EKLE'))

WebUI.click(findTestObject('Object Repository/Page_Kitap, Hobi, Oyuncak, Kulaklk, ok Sata_319555/a_SEPETE GT'))

WebUI.click(findTestObject('Object Repository/Page_Alveri Sepeti  idefix/a_Sil'))

WebUI.click(findTestObject('Object Repository/Page_Alveri Sepeti  idefix/a_Seilen rnler Silindi_fancybox-item fancyb_93a2a5'))
